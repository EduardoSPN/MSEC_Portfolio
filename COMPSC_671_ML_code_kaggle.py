...
# =============================================================================
# Identify most relevant features in Random Forest
# =============================================================================
...
for i in np.arange(0.003, 0.0005, 0.008):
    print(i)
...
# =============================================================================
# IN CASE WE WANT TO USE THEM IN R LATER - For SVM in R

#train data
cols = train_ready.columns.isin(test_ready.columns)

x = train_ready.loc[:,cols].set_index('id')
y = pd.DataFrame(train_ready.loc[:,"price"])

#test data
x_t = test_ready.set_index('id')

# writing to csv file  
x.to_csv(r'x_ready.csv', index = True, header=True)
y.to_csv(r'y_ready.csv', index = True, header=True)
x_t.to_csv(r'x_t_ready.csv', index = True, header=True)

# =============================================================================

## The winner is adaboost with decision trees
